...
export  function Details() {
  ...
  return (
    ...
    <div  className="container mx-auto p-20 max-w-[1320px] mt-25">
      <h1 className="cursor-default text-3xl font-medium mb-5 mx-2 indent-15 whitespace-pre-line">{product.title}</h1>
      <img src={product.miximg} alt={product.title} className="w-[1320px] h-auto object-cover mb-3 rounded-2xl shadow-md" />
      <h6 className="cursor-default text-gray-600 text-xl my-10 indent-15 text-justify whitespace-pre-line hyphens-auto" lang="th" >{product.description1}</h6>
      <p className="cursor-default text-gray-600 text-xl my-10 text-left whitespace-pre-line " >{product.description2}</p>
