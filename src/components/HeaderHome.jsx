...
export default function HeaderHome() {
  return (
    <div className='bg-white py-10 h-auto md:h-[37.5rem] md:mt-30 flex items-center'>
      <div className='container mx-auto max-w-[1320px] md:py-10 p-10 mt-0 md:p-20 md:mt-30 flex flex-col md:flex-row justify-between items-center'>
        <div >
